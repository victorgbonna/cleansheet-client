...
export default function SelectOption(
  {options, onChange, value,label, leftSibling=null,
    ...
    <div style={{position:"relative", width:"100%"}} onClick={() => toggle(!show)} >
        <div className={` cursor-pointer flex justify-between border rounded-md text-sm tablet:text-base text-graySubHd py-3 px-3 gap-x-2 items-center  mt-[4px] border-green ${containerClass || ''} ${isInput && !options.includes(value)?' border-red-100 ':''}`}  
            style={{
            background: '#FFFFFF',
